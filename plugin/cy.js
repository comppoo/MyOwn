...
if (typeof $response == "undefined") {
  ...
  "expires_time" : "4092599349",  "is_auto_renewal" : true  };
    ...
    case aiUrl.test(url):
      ...
      break;
    case qyUrl.test(url):
      c1011["entries"] = [{  "url" : "https://t.m3",  "id" : 1,  "name" : "叮",  "type" : 1,  "pos" : 2  }];
      break;
    case peUrl.test(url):
      c1011["privileges"] = [{  "vip_type" : "svip",  "subscription_chat_quota" : 999  }];
      break;
    case topUrl.test(url):
      c1011["data"] = [{  "badge_type" : "",  "title" : "叮",  "url" : "https://1.com",  "feature_type" : "",  "avatar" : "https://raw.githubusercontent.com"  },...c1011.data];
      break;
    }
